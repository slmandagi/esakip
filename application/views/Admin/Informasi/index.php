        ...
        <div class="the-base">
            <div class="daftar-pesan-terkirim">
                ...
                foreach ($informasi as $i) : ?>
                    ...
                    <div class="pesan-terkirim">
                        <h5 class="user-pengirim"><span style="color: #E1D7C6;">Tujuan : </span><?php echo $i->u_tujuan; ?></h5>
                        <p><?php echo $i->informasi; ?></p>
                        <h5><?php echo $i->date_sended; ?></h5>
                    </div>
                    <hr>
                <?php
                endforeach;
            ...
            <form action="<?= base_url('admin_sakip_sulut/informasi'); ?>" class="form-kirim-pesan-admin" method="POST" enctype="multipart/form-data">
                ...
                <?php if ($error = $this->session->flashdata('msg')) { ?>
                    <h3 class="text-success"><span style="color: #82C3EC;"><?php echo  $error; ?> </span></h3>
                <?php } ?>
