            ...
            <div class="modal-triwulan-user">
                ...
                <div class="content-modal-triwulan-user">
                    <div class="hasil-pengukuran-container">
                        ...
                        <input type="text" disabled value="25" id="jlh-indikator" class="jlh-indikator" disabled>
                    </div>
                    <div class="hasil-pengukuran-container">
                        <label for="tidak-ada-target-input">Tidak Ada Target</label>
                        <input type="text" value="3" class="tidak-ada-target-input" disabled>
                    </div>
                    <div class="tidak-tercapai-user-container">
                        ...
                        <div class="tidak-tercapai-indikator">
                            ...
                            <input value="3" type="text" id="tidak-tercapai-pertama" class="tidak-tercapai-input" disabled>
                        </div>
                        <div class="tidak-tercapai-indikator">
                            <label for="tidak-tercapai-kedua">50.00 s/d 64.99</label>
                            <input value="4" type="text" id="tidak-tercapai-kedua" class="tidak-tercapai-input" disabled>
                        </div>
                        <div class="tidak-tercapai-indikator">
                            <label for="tidak-tercapai-ketiga">65.00 s/d 74.99</label>
                            <input value="0" type="text" id="tidak-tercapai-ketiga" class="tidak-tercapai-input" disabled>
                        </div>
                        <div class="tidak-tercapai-indikator">
                            <label for="tidak-tercapai-keempat">75.00 s/d 89.99</label>
                            <input value="0" type="text" id="tidak-tercapai-keempat" class="tidak-tercapai-input" disabled>
                        </div>
                        <div class="tidak-tercapai-indikator">
                            <label for="tidak-tercapai-kelima">90.00 s/d 99.99</label>
                            <input value="0" type="text" id="tidak-tercapai-kelima" class="tidak-tercapai-input" disabled>
                        </div>
                    </div>
                    <div class="tercapai-melebihi-container">
                        <label for="tercapai-input" style="font-size: 14px;">Tercapai</label>
                        <input value="4" type="text" id="tercapai-input" class="tercapai-input" disabled>
                        <label for="melebihi-target-input" style="font-size: 14px; ">Melebihi Target</label>
                        <input value="5" type="text" id="melebihi-target-input" class="melebihi-target-input" disabled style="margin-left: 0px;">
                    </div>
                </div>
            </div>
        </div>
